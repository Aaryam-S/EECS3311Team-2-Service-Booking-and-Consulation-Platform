...
public class Booking {
    ...
    /**
     * Factory for driving state transitions from a persisted status string.
     * Uses a stub TimeSlot so cancel/reject don't NPE when client/consultant/service are null.
     */
